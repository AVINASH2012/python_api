...
def collect_events(helper, ew):
    ...
    while page_number <6:
        ...
        sorted_results = sorted(final_results, key=lambda x: x["release_date"], reverse=True)
        ...
        page_number +=1
    event = helper.new_event(json.dumps(sorted_results), time=None, host=None, index=None, source=None, sourcetype=None, done=True, unbroken=True)
